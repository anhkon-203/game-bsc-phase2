...
function game_bsc_register_acf_fields() {
	...
	acf_add_local_field_group(array(
		...
		'fields' => array(
			...
			// === BSC Fee Voucher Fields (Voucher hoàn phí giao dịch) ===
			array(
				'key'   => 'field_is_fee_voucher',
				'label' => 'Là voucher hoàn phí giao dịch',
				'name'  => 'is_fee_voucher',
				'type'  => 'true_false',
				'ui'    => 1,
				'default_value' => 0,
				'instructions' => 'Bật nếu đây là voucher hoàn phí giao dịch BSC (có balance giảm dần khi giao dịch).',
			...
			array(
				'key'   => 'field_fee_voucher_denomination',
				'label' => 'Mệnh giá voucher (VND)',
				'name'  => 'fee_voucher_denomination',
				'type'  => 'number',
				'min'   => 1000,
				'step'  => 1000,
				'required' => 0,
				'instructions' => 'Mệnh giá gốc của voucher (VD: 20000, 50000, 100000, 200000, 500000).',
				'wrapper' => array('width' => 33),
				'conditional_logic' => array(
					array(
						array(
			...
			array(
				'key'   => 'field_fee_voucher_validity_days',
				'label' => 'Số ngày hiệu lực',
				'name'  => 'fee_voucher_validity_days',
				'type'  => 'number',
				'min'   => 1,
				'step'  => 1,
				'default_value' => 30,
				'required' => 0,
				'instructions' => 'Số ngày voucher có hiệu lực kể từ ngày đổi (mặc định 30 ngày).',
